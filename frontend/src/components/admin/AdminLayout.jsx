    ...
    <div className="admin-shell min-h-screen flex" data-admin-theme={theme}>
      <aside className="admin-sidebar w-60 shrink-0 border-r flex flex-col">
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${
                  active
                    ...
                    : 'admin-text-muted hover:admin-text-body hover:bg-black/5 dark:hover:bg-surface-200'
                }`}
              >
                <Icon size={18} />
                {item.label}
        ...
        <div className="px-4 py-4 border-t border-inherit space-y-1">
          <button
            onClick={toggle}
            className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-sm admin-text-muted hover:admin-text-body hover:bg-black/5 dark:hover:bg-surface-200 transition"
          >
